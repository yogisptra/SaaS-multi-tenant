<template>
  <div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <!-- Welcome Card -->
      <div class="md:col-span-2 bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
        <div class="relative z-10">
          ...
          <router-link :to="{ name: 'Projects' }" class="bg-white text-primary-700 px-6 py-2.5 rounded-lg font-semibold hover:bg-slate-50 transition-all-smooth inline-block shadow-sm">
            View All Projects
          </router-link>
        </div>
